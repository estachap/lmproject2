...
use Lm\CommitBundle\Model\map\FileTableMap;
...
abstract class BaseFilePeer
{
    ...
    const OM_CLASS = 'Lm\\CommitBundle\\Model\\File';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Lm\\CommitBundle\\Model\\map\\FileTableMap';
    ...
    /** the column name for the commit_id field */
    const COMMIT_ID = 'file.commit_id';

    /** the column name for the commit_status field */
    const COMMIT_STATUS = 'file.commit_status';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Filename', 'CommitId', 'CommitStatus', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'filename', 'commitId', 'commitStatus', ),
        BasePeer::TYPE_COLNAME => array (FilePeer::ID, FilePeer::FILENAME, FilePeer::COMMIT_ID, FilePeer::COMMIT_STATUS, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'FILENAME', 'COMMIT_ID', 'COMMIT_STATUS', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'filename', 'commit_id', 'commit_status', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Filename' => 1, 'CommitId' => 2, 'CommitStatus' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'filename' => 1, 'commitId' => 2, 'commitStatus' => 3, ),
        BasePeer::TYPE_COLNAME => array (FilePeer::ID => 0, FilePeer::FILENAME => 1, FilePeer::COMMIT_ID => 2, FilePeer::COMMIT_STATUS => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'FILENAME' => 1, 'COMMIT_ID' => 2, 'COMMIT_STATUS' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'filename' => 1, 'commit_id' => 2, 'commit_status' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(FilePeer::COMMIT_ID);
            $criteria->addSelectColumn(FilePeer::COMMIT_STATUS);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.filename');
            $criteria->addSelectColumn($alias . '.commit_id');
            $criteria->addSelectColumn($alias . '.commit_status');
        }
    }
    ...
    /**
     * Returns the number of rows matching criteria, joining the related Propelcommit table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinPropelcommit(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(FilePeer::COMMIT_ID, PropelcommitPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of File objects pre-filled with their Propelcommit objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinPropelcommit(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key2 = PropelcommitPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = PropelcommitPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    PropelcommitPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (File) to $obj2 (Propelcommit)
                $obj2->addFile($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        PropelcommitPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + PropelcommitPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined Propelcommit rows

            $key2 = PropelcommitPeer::getPrimaryKeyHashFromRow($row, $startcol2);
            if ($key2 !== null) {
                $obj2 = PropelcommitPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                ...
                // Add the $obj1 (File) to the collection in $obj2 (Propelcommit)
                $obj2->addFile($obj1);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseFilePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Lm\CommitBundle\Model\map\FileTableMap());
      }
    }
