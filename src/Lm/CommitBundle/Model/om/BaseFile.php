...
abstract class BaseFile extends BaseObject implements Persistent
{
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getCommitId(),
            $keys[3] => $this->getCommitStatus(),
        );
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aPropelcommit) {
                $result['Propelcommit'] = $this->aPropelcommit->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setCommitId($value);
                break;
            case 3:
                $this->setCommitStatus($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setCommitId($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setCommitStatus($arr[$keys[3]]);
    }
